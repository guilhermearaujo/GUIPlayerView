#
#  Be sure to run `pod spec lint GUIPlayerView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Guilherme Araújo"
  # s.authors            = { "Guilherme Araújo" => "guilhermeama@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Guilherme Araújo"
